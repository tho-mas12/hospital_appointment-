...
import {
  ...
  ClipboardList, HeartPulse, Building2, Award, Ambulance, Facebook,
  Twitter, Instagram, Linkedin, RefreshCw, Trash2, Plus, Quote
} from "lucide-react";
import {
...
const DOCTORS = [
  { id: 1, name: "Dr. Ananya Rao", dept: "cardiology", spec: "Interventional Cardiologist", exp: 14, qual: "MBBS, MD, DM (Cardiology)", rating: 4.9, reviews: 312, days: ["Mon", "Tue", "Thu", "Fri"], fee: 700, room: "B-204" },
  { id: 2, name: "Dr. Vikram Iyer", dept: "cardiology", spec: "Cardiac Electrophysiologist", exp: 9, qual: "MBBS, MD, DNB", rating: 4.7, reviews: 158, days: ["Wed", "Fri", "Sat"], fee: 650, room: "B-207" },
  { id: 3, name: "Dr. Meera Krishnan", dept: "neurology", spec: "Consultant Neurologist", exp: 17, qual: "MBBS, MD, DM (Neurology)", rating: 4.8, reviews: 289, days: ["Mon", "Wed", "Fri"], fee: 800, room: "C-112" },
  { id: 4, name: "Dr. Arjun Menon", dept: "orthopedics", spec: "Joint Replacement Surgeon", exp: 12, qual: "MBBS, MS (Ortho)", rating: 4.6, reviews: 204, days: ["Tue", "Thu", "Sat"], fee: 600, room: "A-018" },
  { id: 5, name: "Dr. Priya Suresh", dept: "pediatrics", spec: "Neonatologist", exp: 11, qual: "MBBS, MD (Paediatrics)", rating: 4.9, reviews: 401, days: ["Mon", "Tue", "Wed", "Thu", "Fri"], fee: 500, room: "D-005" },
  { id: 6, name: "Dr. Karthik Balan", dept: "dermatology", spec: "Clinical Dermatologist", exp: 8, qual: "MBBS, MD (DVL)", rating: 4.5, reviews: 137, days: ["Wed", "Thu", "Sat"], fee: 550, room: "A-221" },
  { id: 7, name: "Dr. Fathima Noor", dept: "general", spec: "General Physician", exp: 15, qual: "MBBS, MD (Gen. Med)", rating: 4.7, reviews: 356, days: ["Mon", "Tue", "Wed", "Thu", "Fri", "Sat"], fee: 400, room: "G-101" },
  { id: 8, name: "Dr. Rohan Desai", dept: "ent", spec: "ENT & Cochlear Surgeon", exp: 10, qual: "MBBS, MS (ENT)", rating: 4.6, reviews: 172, days: ["Mon", "Thu", "Fri"], fee: 550, room: "C-330" },
  { id: 9, name: "Dr. Sneha Pillai", dept: "dental", spec: "Orthodontist", exp: 7, qual: "BDS, MDS", rating: 4.8, reviews: 221, days: ["Tue", "Wed", "Fri", "Sat"], fee: 450, room: "E-014" },
  { id: 10, name: "Dr. Hari Prasad", dept: "orthopedics", spec: "Spine Surgeon", exp: 19, qual: "MBBS, MS, Fellowship (Spine)", rating: 4.9, reviews: 268, days: ["Mon", "Wed", "Sat"], fee: 850, room: "A-024" },
];
...
const SEED_APPTS = [
  { id: "APT-10041", patient: "Nithya Raman", age: 29, gender: "Female", phone: "+91 98400 11223", email: "nithya@mail.com", doctorId: 1, dept: "cardiology", date: addDays(1), slot: "10:00 AM", symptoms: "Chest tightness while climbing stairs", status: "Confirmed", fee: 700, prescription: "", notes: "" },
  { id: "APT-10042", patient: "Nithya Raman", age: 29, gender: "Female", phone: "+91 98400 11223", email: "nithya@mail.com", doctorId: 7, dept: "general", date: addDays(4), slot: "05:00 PM", symptoms: "Recurring fever, mild cough", status: "Pending", fee: 400, prescription: "", notes: "" },
  { id: "APT-10038", patient: "Nithya Raman", age: 29, gender: "Female", phone: "+91 98400 11223", email: "nithya@mail.com", doctorId: 6, dept: "dermatology", date: addDays(-6), slot: "11:00 AM", symptoms: "Skin rash on forearm", status: "Completed", fee: 550, prescription: "Mometasone 0.1% cream — apply at night, 10 days", notes: "Contact dermatitis. Review only if it spreads." },
  { id: "APT-10033", patient: "Nithya Raman", age: 29, gender: "Female", phone: "+91 98400 11223", email: "nithya@mail.com", doctorId: 9, dept: "dental", date: addDays(-21), slot: "04:30 PM", symptoms: "Routine cleaning", status: "Completed", fee: 450, prescription: "—", notes: "Scaling done. Next cleaning in 6 months." },
  { id: "APT-10044", patient: "Aravind Kumar", age: 46, gender: "Male", phone: "+91 90031 55447", email: "aravind@mail.com", doctorId: 1, dept: "cardiology", date: iso(today), slot: "09:30 AM", symptoms: "Follow-up after angiogram", status: "Confirmed", fee: 700, prescription: "", notes: "" },
  { id: "APT-10045", patient: "Divya Shankar", age: 34, gender: "Female", phone: "+91 90031 88220", email: "divya@mail.com", doctorId: 1, dept: "cardiology", date: iso(today), slot: "11:00 AM", symptoms: "Palpitations at night", status: "Pending", fee: 700, prescription: "", notes: "" },
  { id: "APT-10046", patient: "Mohan Das", age: 61, gender: "Male", phone: "+91 94441 20933", email: "mohan@mail.com", doctorId: 1, dept: "cardiology", date: iso(today), slot: "04:00 PM", symptoms: "BP review, medication refill", status: "Confirmed", fee: 700, prescription: "", notes: "" },
  { id: "APT-10047", patient: "Sara Thomas", age: 8, gender: "Female", phone: "+91 99529 43310", email: "sara.g@mail.com", doctorId: 5, dept: "pediatrics", date: iso(today), slot: "10:30 AM", symptoms: "Vaccination — booster dose", status: "Confirmed", fee: 500, prescription: "", notes: "" },
  { id: "APT-10029", patient: "Ganesh V", age: 52, gender: "Male", phone: "+91 98847 33019", email: "ganesh@mail.com", doctorId: 4, dept: "orthopedics", date: addDays(-3), slot: "09:00 AM", symptoms: "Knee pain", status: "Cancelled", fee: 600, prescription: "", notes: "" },
];
...
export default function App() {
  ...
  return (
    <div className={`min-h-screen ${S.page} transition-colors duration-300`}>
      <Styles />
      <EmergencyBanner />
      <Nav {...{ S, dark, setDark, route: active, go, user, setUser, menuOpen, setMenuOpen, toast }} />

      <main>
        {active === "home" && <Home {...{ S, go, appts }} />}
        {active === "doctors" && <DoctorsPage {...{ S, go }} />}
        {active === "departments" && <DepartmentsPage {...{ S, go }} />}
        {active === "book" && (
          <BookPage {...{ S, go, toast, appts, setAppts, user, prefill, setPrefill, reschedule, setReschedule }} />
        )}
        {active === "about" && <AboutPage {...{ S, go }} />}
        {active === "contact" && <ContactPage {...{ S, toast }} />}
        {(active === "login" || active === "register") && (
          <AuthPage {...{ S, mode: active, go, setUser, toast }} />
        )}
        {active === "patient" && (
          <PatientDash {...{ S, user, appts, setAppts, toast, go, setReschedule }} />
        )}
        {active === "doctor" && <DoctorDash {...{ S, user, appts, setAppts, toast }} />}
        {active === "admin" && <AdminDash {...{ S, appts, toast }} />}
      </main>
...
function Nav({ S, dark, setDark, route, go, user, setUser, menuOpen, setMenuOpen, toast }) {
          ...
          <div className="ml-auto flex items-center gap-2">
            ...
            {user ? (
              <div className="hidden sm:flex items-center gap-2">
                ...
                <button onClick={() => { setUser(null); go("home"); toast("Signed out", "info"); }}
                  aria-label="Sign out"
          ...
          <div className={`pt-2 mt-2 border-t ${S.line} flex gap-2`}>
            {user ? (
              <>
                ...
                <button onClick={() => { setUser(null); go("home"); }} className="px-3 py-2.5 rounded-lg text-sm font-medium text-rose-500">Sign out</button>
              </>
            ) : (
              <>
...
function Home({ S, go, appts }) {
  return (
    <>
      <Hero S={S} go={go} />
      <Stats S={S} />
      <AboutStrip S={S} />
      <DeptGrid S={S} go={go} limit={8} />
      <FeaturedDoctors S={S} go={go} />
      <HowItWorks S={S} />
      <Testimonials S={S} />
      <HealthTips S={S} />
      <FAQ S={S} />
  ...
  return (
    <div className="relative overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 pt-16 pb-20 grid lg:grid-cols-2 gap-12 items-center">
        ...
        {/* Signature: a live "next available slot" card sitting on an ECG trace */}
          ...
          <div className={`relative rounded-3xl p-6 shadow-2xl ${S.card}`}>
            ...
            <div className="relative pt-16">
              ...
              <div className="mt-4 space-y-3">
                {[DOCTORS[6], DOCTORS[4], DOCTORS[0]].map((d, i) => (
                  <div key={d.id} className={`flex items-center gap-3 p-3 rounded-2xl ${S.soft}`}>
                    <Avatar name={d.name} size={44} i={i} />
                    <div className="min-w-0 flex-1">
                      <p className={`font-semibold text-sm truncate ${S.head}`}>{d.name}</p>
                      <p className={`text-xs truncate ${S.sub}`}>{d.spec}</p>
                    </div>
                    <div className="text-right">
                      <p className="text-sm font-bold text-emerald-600">{["10:30 AM", "11:00 AM", "04:30 PM"][i]}</p>
        ...
        {list.map((d, i) => (
          <button key={d.id} onClick={() => go("book", { prefill: { dept: d.id } })}
            ...
            <p className="mt-3 text-xs font-semibold text-sky-600 flex items-center gap-1">
              {d.doctors} doctors <ChevronRight className="w-3 h-3 group-hover:translate-x-1 transition-transform" />
            </p>
          </button>
        ))}
      </div>
...
function FeaturedDoctors({ S, go }) {
  ...
  return (
    <Section className="pt-0">
      ...
      <div className="mt-10 grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
        {top.map((d, i) => <DoctorCard key={d.id} d={d} i={i} S={S} go={go} />)}
      </div>
    </Section>
  );
}
    ...
    <div className={`fade-up rounded-2xl p-6 ${S.card} hover:-translate-y-1 transition-transform`} style={{ animationDelay: `${i * 50}ms` }}>
      <div className="flex items-start gap-4">
        ...
        <div className="min-w-0">
          ...
          <p className="text-sm text-sky-600">{d.spec}</p>
      ...
      <dl className={`mt-5 space-y-2 text-sm ${S.sub}`}>
        <div className="flex justify-between gap-3">
          <dt>Experience</dt><dd className={`font-medium ${S.head}`}>{d.exp} years</dd>
        </div>
        <div className="flex justify-between gap-3">
          <dt>Qualification</dt><dd className={`font-medium text-right ${S.head}`}>{d.qual}</dd>
        </div>
        <div className="flex justify-between gap-3">
        ...
        {["Mon", "Tue", "Wed", "Thu", "Fri", "Sat"].map((day) => (
          <span key={day}
            className={`px-2 py-1 rounded-lg text-[11px] font-medium ${
              d.days.includes(day) ? "bg-emerald-500/12 text-emerald-600" : `${S.chip} opacity-40 line-through`}`}>
            {day}
          </span>
        ))}
      </div>

      <button onClick={() => go("book", { prefill: { dept: d.dept, doctorId: d.id } })}
      ...
      <div className="mt-10 grid md:grid-cols-3 gap-5">
        {HEALTH_TIPS.map((p, i) => (
          <article key={p.title} className={`rounded-2xl overflow-hidden ${S.card} hover:-translate-y-1 transition-transform`}>
            <div className={`h-28 bg-gradient-to-br ${AV_COLORS[i]} grid place-items-center`}>
  ...
  const list = useMemo(() => {
    let r = DOCTORS.filter((d) =>
      ...
      (d.name.toLowerCase().includes(q.toLowerCase()) ||
        ...
        DEPT_NAME(d.dept).toLowerCase().includes(q.toLowerCase()))
    );
    if (sort === "rating") r = [...r].sort((a, b) => b.rating - a.rating);
    if (sort === "exp") r = [...r].sort((a, b) => b.exp - a.exp);
    ...
    <Section>
      ...
      {list.length === 0 ? (
        ...
        <div className="mt-6 grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
          {list.map((d, i) => <DoctorCard key={d.id} d={d} i={i} S={S} go={go} />)}
        </div>
      )}
    </Section>
  );
...
function DepartmentsPage({ S, go }) {
  return (
    <>
      <Section className="pb-0">
        <Eyebrow>Departments</Eyebrow>
        <h1 className={`mt-4 text-4xl font-bold tracking-tight ${S.head}`}>Eight specialties, one desk</h1>
...
function AuthPage({ S, mode, go, setUser, toast }) {
  ...
  const submit = () => {
    ...
    setTimeout(() => {
      setBusy(false);
      const name = isLogin
        ? { patient: "Nithya Raman", doctor: "Dr. Ananya Rao", admin: "Hospital Admin" }[role]
        : f.name;
      setUser({ name, email: f.email, role, phone: f.phone || "+91 98400 11223" });
      toast(isLogin ? `Welcome back, ${name.split(" ")[0]}` : "Account created. You're signed in.");
      go(role);
    }, 700);
  };
            ...
            <>
              ...
              <div className="mt-5 space-y-4">
                ...
                <div className={`rounded-xl p-3 text-xs ${S.soft} ${S.sub}`}>
                  <span className={`font-semibold ${S.head}`}>Demo build.</span> Any email and a 6-character password will sign you
                  in as the role you picked. In the full stack, this posts to <code>/api/auth/login</code> and stores a JWT.
                </div>
              </div>
            </>
          )}
...
function BookPage({ S, go, toast, appts, setAppts, user, prefill, setPrefill, reschedule, setReschedule }) {
  const [f, setF] = useState(() => ({
    ...
    ...(prefill || {}),
    ...(reschedule ? { ...reschedule, doctorId: reschedule.doctorId, date: "", slot: "" } : {}),
  }));
  const [err, setErr] = useState({});
  ...
  const deptDoctors = DOCTORS.filter((d) => !f.dept || d.dept === f.dept);
  const chosen = DOC(Number(f.doctorId));

  const takenSlots = appts
    .filter((a) => a.doctorId === Number(f.doctorId) && a.date === f.date && a.status !== "Cancelled")
    .map((a) => a.slot);

  const dayName = f.date ? ["Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat"][new Date(f.date + "T00:00:00").getDay()] : null;
  const doctorSits = !chosen.id || !dayName || chosen.days.includes(dayName);
  ...
  const validate = () => {
    ...
    else if (!doctorSits) e.date = `${chosen.name} doesn't sit on ${dayName}. Available: ${chosen.days.join(", ")}`;
  ...
  const review = () => { if (validate()) setConfirm(true); };

  const submit = () => {
    const rec = {
      id: "APT-" + Math.floor(10050 + Math.random() * 900),
      patient: f.patient, age: Number(f.age), gender: f.gender, phone: f.phone, email: f.email,
      doctorId: Number(f.doctorId), dept: f.dept, date: f.date, slot: f.slot,
      symptoms: f.symptoms, status: "Pending", fee: chosen.fee, prescription: "", notes: "",
    };
    setAppts((a) => (reschedule ? [...a.filter((x) => x.id !== reschedule.id), rec] : [...a, rec]));
    setConfirm(false);
    setDone(rec);
    if (reschedule) setReschedule(null);
    toast(reschedule ? "Appointment rescheduled" : "Appointment booked");
  };

  if (done) return <BookedScreen S={S} rec={done} go={go} reset={() => { setDone(null); setF(emptyBooking); }} />;

  return (
    <Section>
      <div className="max-w-3xl mx-auto">
        <Eyebrow>{reschedule ? `Rescheduling ${reschedule.id}` : "Book appointment"}</Eyebrow>
          ...
          <div className="mt-5 grid sm:grid-cols-2 gap-4">
            ...
            <Field S={S} label="Doctor" req error={err.doctorId}>
              <select value={f.doctorId} onChange={(e) => set("doctorId", e.target.value)}
                ...
                {deptDoctors.map((d) => <option key={d.id} value={d.id}>{d.name} — ₹{d.fee}</option>)}
              </select>
            </Field>
            ...
            <div>
              ...
              <div className={`px-3.5 py-2.5 rounded-xl border text-sm ${S.input} ${S.sub}`}>
                {chosen.id ? chosen.days.join(" · ") : "Select a doctor to see their days"}
              </div>
            </div>
          </div>
          ...
          <div className="mt-6">
            ...
            {!f.doctorId || !f.date ? (
              ...
              <div className="rounded-2xl p-6 text-center text-sm bg-amber-500/10 text-amber-600">
                {chosen.name} doesn't consult on {dayName}. Try {chosen.days.join(", ")}.
              </div>
            ) : (
              <div className="grid grid-cols-3 sm:grid-cols-4 gap-2">
                {SLOTS.map((s) => {
                  ...
                  const on = f.slot === s;
                  return (
                    <button key={s} disabled={taken} onClick={() => set("slot", s)}
          ...
          {chosen.id && (
            <div className={`mt-6 flex flex-wrap items-center justify-between gap-3 rounded-2xl p-4 ${S.soft}`}>
              <div className="flex items-center gap-3">
                <Avatar name={chosen.name} size={40} i={chosen.id} />
                <div>
                  <p className={`text-sm font-semibold ${S.head}`}>{chosen.name}</p>
                  <p className={`text-xs ${S.sub}`}>{chosen.spec} · Room {chosen.room}</p>
                </div>
              </div>
...
function BookedScreen({ S, rec, go, reset }) {
  const d = DOC(rec.doctorId);
  return (
    <Section>
      <div className={`max-w-lg mx-auto fade-up rounded-3xl p-8 text-center ${S.card}`}>
        ...
        <div className={`mt-6 rounded-2xl p-5 text-left ${S.soft}`}>
          <div className="flex items-center justify-between">
            ...
            <span className="font-mono font-bold text-sky-600">{rec.id}</span>
          </div>
          <div className={`mt-4 pt-4 border-t ${S.line} space-y-2 text-sm`}>
            <Row S={S} k="Doctor" v={d.name} />
            <Row S={S} k="Department" v={DEPT_NAME(rec.dept)} />
            <Row S={S} k="When" v={`${rec.date} at ${rec.slot}`} />
            <Row S={S} k="Room" v={d.room} />
        ...
        <div className="mt-6 flex flex-col sm:flex-row gap-3">
          <button onClick={() => downloadSlip(rec)}
...
function downloadSlip(a) {
  const d = DOC(a.doctorId);
  const html = `<!doctype html><html><head><meta charset="utf-8"><title>Appointment ${a.id}</title>
...
<div style="text-align:right"><div class="tag">Reference</div><div style="font-weight:700;color:#0369a1">${a.id}</div></div></div>
<table>
<tr><td>Patient</td><td>${a.patient}</td></tr>
<tr><td>Age / Gender</td><td>${a.age} / ${a.gender}</td></tr>
<tr><td>Phone</td><td>${a.phone}</td></tr>
<tr><td>Doctor</td><td>${d.name}</td></tr>
<tr><td>Specialisation</td><td>${d.spec}</td></tr>
<tr><td>Department</td><td>${DEPT_NAME(a.dept)}</td></tr>
<tr><td>Date and time</td><td>${a.date} at ${a.slot}</td></tr>
<tr><td>Room</td><td>${d.room}</td></tr>
...
Front desk 0431 400 1200 · Emergency 0431 400 1188 (24/7)</div></body></html>`;
  try {
    ...
    link.href = url;
    link.download = `${a.id}-appointment-slip.html`;
...
function ApptCard({ S, a, children }) {
  const d = DOC(a.doctorId);
  return (
    <div className={`rounded-2xl p-5 ${S.card}`}>
      <div className="flex flex-wrap items-start justify-between gap-3">
        <div className="flex items-start gap-3 min-w-0">
          <Avatar name={d.name} size={46} i={a.doctorId} />
          <div className="min-w-0">
            <p className={`font-semibold ${S.head}`}>{d.name}</p>
            <p className={`text-xs ${S.sub}`}>{d.spec} · {DEPT_NAME(a.dept)} · Room {d.room}</p>
            <p className="mt-1 font-mono text-xs text-sky-600">{a.id}</p>
          </div>
        </div>
...
function PatientDash({ S, user, appts, setAppts, toast, go, setReschedule }) {
  const [tab, setTab] = useState("upcoming");
  const [cancelling, setCancelling] = useState(null);
  const [profile, setProfile] = useState({ name: user.name, email: user.email, phone: user.phone || "+91 98400 11223", address: "12 Thillai Nagar, Tiruchirappalli", blood: "O+", allergies: "Penicillin" });

  const mine = appts.filter((a) => a.email === user.email || a.patient === user.name);
  const upcoming = mine.filter((a) => a.date >= iso(today) && a.status !== "Cancelled" && a.status !== "Completed")
    .sort((a, b) => a.date.localeCompare(b.date));
  const history = mine.filter((a) => !upcoming.includes(a)).sort((a, b) => b.date.localeCompare(a.date));

  const doCancel = () => {
    setAppts((list) => list.map((a) => (a.id === cancelling.id ? { ...a, status: "Cancelled" } : a)));
    toast(`${cancelling.id} cancelled`, "info");
    setCancelling(null);
  };
  ...
  return (
    <>
        ...
        {tab === "profile" && (
          <div className={`max-w-2xl rounded-2xl p-6 ${S.card}`}>
            ...
            <div className="mt-6 grid sm:grid-cols-2 gap-4">
              ...
              <Field S={S} label="Email"><input value={profile.email} onChange={(e) => setProfile({ ...profile, email: e.target.value })} className={inputCls(S)} /></Field>
              ...
              <Field S={S} label="Blood group"><input value={profile.blood} onChange={(e) => setProfile({ ...profile, blood: e.target.value })} className={inputCls(S)} /></Field>
            ...
            <button onClick={() => toast("Profile updated")} className={`mt-6 ${btnPrimary}`}>Save changes</button>
          </div>
        )}
      </DashShell>
      ...
      <Modal S={S} open={!!cancelling} onClose={() => setCancelling(null)}>
        ...
        <p className={`mt-2 text-sm ${S.sub}`}>
          {cancelling && `${cancelling.id} with ${DOC(cancelling.doctorId).name} on ${cancelling.date} at ${cancelling.slot}.`}
...
function DoctorDash({ S, user, appts, setAppts, toast }) {
  ...
  const [slots, setSlots] = useState(SLOTS.slice(0, 8));

  const meId = 1; // demo: signed-in doctor maps to Dr. Ananya Rao
  const me = DOC(meId);
  const mine = appts.filter((a) => a.doctorId === meId);
  const todays = mine.filter((a) => a.date === iso(today));
  const patients = Array.from(new Set(mine.map((a) => a.patient)));
  ...
  const saveRx = () => {
    setAppts((list) => list.map((a) => (a.id === rx.id ? { ...a, ...draft, status: "Completed" } : a)));
    toast(`Prescription saved for ${rx.patient}`);
    setRx(null);
  };
  ...
  return (
    <>
      <DashShell S={S} tabs={tabs} tab={tab} setTab={setTab}
        title={me.name} sub={`${me.spec} · Room ${me.room} · ${todays.length} appointments today`}
        right={
          ...
          <>
            ...
            <div className="mt-6 grid lg:grid-cols-2 gap-5">
              {todays.length === 0 ? (
                ...
                <PatientApptCard key={a.id} S={S} a={a}>
                  {a.status === "Pending" && (
                    <button onClick={() => setStatus(a.id, "Confirmed")} className={btnPrimary}>Approve</button>
                  )}
                  ...
                  {a.status !== "Cancelled" && a.status !== "Completed" && (
                    <button onClick={() => setStatus(a.id, "Cancelled")} className={btnDanger}>Cancel</button>
                  )}
                </PatientApptCard>
              ))}
            </div>
          ...
          <div className={`rounded-2xl overflow-hidden ${S.card}`}>
            <div className="overflow-x-auto">
              <table className="w-full text-sm">
                ...
                <tbody>
                  {[...mine].sort((a, b) => b.date.localeCompare(a.date)).map((a) => (
                    <tr key={a.id} className={`border-t ${S.line} ${S.hoverRow}`}>
                      <td className="px-5 py-3.5">
                        <div className="flex items-center gap-2.5">
                          <Avatar name={a.patient} size={30} i={a.patient.length} />
                          <span className={`font-medium ${S.head}`}>{a.patient}</span>
                        </div>
                      </td>
            ...
            <div className={`rounded-2xl p-6 ${S.card}`}>
              ...
              <div className="mt-5 grid grid-cols-3 gap-2">
                {SLOTS.map((s) => {
                  ...
                  return (
                    <button key={s}
                      onClick={() => setSlots(on ? slots.filter((x) => x !== s) : [...slots, s])}
                      className={`py-2.5 rounded-xl text-sm font-medium border transition-all focus:outline-none focus:ring-2 focus:ring-sky-500 ${
              ...
              <button onClick={() => toast(`Availability saved — ${slots.length} slots live`)} className={`mt-6 w-full py-3 rounded-xl ${btnPrimary}`}>
                Save availability
              </button>
            </div>
          </div>
      ...
      <Modal S={S} open={!!rx} onClose={() => setRx(null)} wide>
        {rx && (
          <>
            <h2 className={`text-xl font-bold ${S.head}`}>Prescription for {rx.patient}</h2>
...
function PatientApptCard({ S, a, children }) {
  return (
    <div className={`rounded-2xl p-5 ${S.card}`}>
      <div className="flex flex-wrap items-start justify-between gap-3">
        <div className="flex items-start gap-3">
          <Avatar name={a.patient} size={46} i={a.patient.length} />
          <div>
            <p className={`font-semibold ${S.head}`}>{a.patient}</p>
            <p className={`text-xs ${S.sub}`}>{a.age} · {a.gender} · {a.phone}</p>
            <p className="mt-1 font-mono text-xs text-sky-600">{a.id}</p>
          </div>
        </div>
        <StatusPill status={a.status} />
      </div>
      <div className={`mt-4 flex flex-wrap gap-4 rounded-xl p-3 text-sm ${S.soft}`}>
        <span className="flex items-center gap-2"><Clock className="w-4 h-4 text-sky-500" />{a.slot}</span>
        <span className="flex items-center gap-2"><Calendar className="w-4 h-4 text-sky-500" />{a.date}</span>
      </div>
      <p className={`mt-3 text-sm ${S.sub}`}><span className={`font-medium ${S.head}`}>Complaint: </span>{a.symptoms}</p>
      {a.prescription && <p className="mt-2 text-sm p-3 rounded-xl bg-emerald-500/10 text-emerald-700"><span className="font-semibold">Rx: </span>{a.prescription}</p>}
      {children && <div className="mt-4 flex flex-wrap gap-2">{children}</div>}
    </div>
  );
}
...
function AdminDash({ S, appts, toast }) {
  const [tab, setTab] = useState("overview");

  const revenue = appts.filter((a) => a.status !== "Cancelled").reduce((s, a) => s + a.fee, 0);
  const pending = appts.filter((a) => a.status === "Pending").length;
  const todayCount = appts.filter((a) => a.date === iso(today)).length;
  const patients = Array.from(new Set(appts.map((a) => a.patient)));

  const byDept = DEPARTMENTS.map((d) => ({
    name: d.name.length > 9 ? d.name.slice(0, 8) + "…" : d.name,
    appointments: appts.filter((a) => a.dept === d.id).length,
  }));
  ...
  const trend = Array.from({ length: 7 }, (_, i) => {
    ...
    return {
      day: day.slice(5),
      booked: appts.filter((a) => a.date === day).length + [6, 9, 7, 11, 8, 13, 10][i],
    };
  });
      ...
      {tab === "overview" && (
        <>
          <div className="grid grid-cols-2 lg:grid-cols-5 gap-4">
            <StatCard S={S} icon={Users} label="Total patients" value={patients.length} note="all time" tone="sky" />
            <StatCard S={S} icon={Stethoscope} label="Total doctors" value={DOCTORS.length} note="active" tone="violet" />
            <StatCard S={S} icon={Calendar} label="Today's appointments" value={todayCount} tone="emerald" />
            <StatCard S={S} icon={TrendingUp} label="Revenue booked" value={`₹${revenue.toLocaleString("en-IN")}`} tone="emerald" />
            <StatCard S={S} icon={Clock} label="Pending approval" value={pending} note="needs action" tone="amber" />
          </div>

          <div className="mt-6 grid lg:grid-cols-3 gap-5">
            <div className={`lg:col-span-2 rounded-2xl p-6 ${S.card}`}>
              <h2 className={`font-bold ${S.head}`}>Bookings over the last 7 days</h2>
      ...
      {tab === "appointments" && (
        <Table S={S} head={["Reference", "Patient", "Doctor", "Department", "Date", "Slot", "Fee", "Status"]}
          rows={[...appts].sort((a, b) => b.date.localeCompare(a.date)).map((a) => [
            <span className="font-mono text-xs text-sky-600">{a.id}</span>,
            a.patient, DOC(a.doctorId).name, DEPT_NAME(a.dept), a.date, a.slot,
            `₹${a.fee}`, <StatusPill status={a.status} />,
          ])} />
      )}

      {tab === "doctors" && (
        <Table S={S} head={["Doctor", "Specialisation", "Experience", "Fee", "Rating", "Booked", "Days"]}
          rows={DOCTORS.map((d) => [
            <span className="flex items-center gap-2.5"><Avatar name={d.name} size={30} i={d.id} />
              <span className={`font-medium ${S.head}`}>{d.name}</span></span>,
            d.spec, `${d.exp} yrs`, `₹${d.fee}`,
            <span className="flex items-center gap-1.5"><Stars value={d.rating} /><span className="text-xs">{d.rating}</span></span>,
            appts.filter((a) => a.doctorId === d.id).length,
            d.days.join(", "),
          ])} />
      )}

      {tab === "patients" && (
        <Table S={S} head={["Patient", "Age", "Gender", "Phone", "Visits", "Last seen"]}
          rows={patients.map((p) => {
            const rec = appts.filter((a) => a.patient === p).sort((a, b) => b.date.localeCompare(a.date));
            return [
              <span className="flex items-center gap-2.5"><Avatar name={p} size={30} i={p.length} />
                <span className={`font-medium ${S.head}`}>{p}</span></span>,
              rec[0].age, rec[0].gender, rec[0].phone, rec.length, rec[0].date,
            ];
          })} />
      )}
          ...
          {DEPARTMENTS.map((d) => (
            <div key={d.id} className={`rounded-2xl p-5 ${S.card}`}>
              ...
              <div className={`mt-4 pt-4 border-t ${S.line} flex justify-between text-sm`}>
                <span className={S.sub}>Doctors</span><span className={`font-semibold ${S.head}`}>{d.doctors}</span>
              </div>
              <div className="flex justify-between text-sm">
                <span className={S.sub}>Booked</span>
                <span className="font-semibold text-sky-600">{appts.filter((a) => a.dept === d.id).length}</span>
              </div>
            </div>
          ))}
        </div>
